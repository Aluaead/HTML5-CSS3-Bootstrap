...
const tasks = [
	new task(1,'第一次作业','2016级H5方向-李文轩',
	'2018-09-29 16:49',5,9,32,23),
	new task(2,'第二次作业','2016级H5方向-李文轩',
	'2018-10-02 12:42',3,9,3,52),
	new task(3,'第三次作业','2016级H5方向-李文轩',
	'2018-10-09 14:49',2,2,30,22),
	new task(4,'第四次作业','2016级H5方向-李文轩',
	'2018-10-19 15:32',2,9,3,25),
	new task(5,'第五次作业','2016级H5方向-李文轩',
...
const communitys = [
	...
	'2016级H5方向-李文轩','2018-10-13',354,32),
	...
	'2016级H5方向-李文轩','2018-10-13',453,43),
	...
	'2016级H5方向-李文轩','2018-10-13',713,45),
	...
	'2016级H5方向-李文轩','2018-10-13',131,35),
	...
	'2016级H5方向-李文轩','2018-10-13',242,13),
	...
	'2016级H5方向-李文轩','2018-10-13',421,21),
	...
	'2016级H5方向-李文轩','2018-10-13',134,32),
...
// XueLi.get('/api/',(req,res)=>{
//     res.json(lessons);
// })

XueLi.get('/api/lesson',(req,res)=>{
    res.json(lessons);
})
XueLi.get('/api/lesson/:id', (req, res) => {
    // req.params 表示请求的是那个id 在下列的res进行判断
    res.json(lessons.find((ele)=>ele.id == req.params.id));
});
// Lesson.get('/api/lesson/:id',(req,res)=>{
// 	res.json(lessons.filter((ele)=>ele.id == req.params.id));
// });

XueLi.get('/api/course',(req,res)=>{
    res.json(courses);
})
XueLi.get('/api/course/:id', (req, res) => {
    // req.params 表示请求的是那个id 在下列的res进行判断
    res.json(courses.find((ele)=>ele.id == req.params.id));
});

XueLi.get('/api/community',(req,res)=>{
    res.json(communitys);
})
XueLi.get('/api/task',(req,res)=>{
    res.json(tasks);
})
// XueLi.get('/api/community/:id', (req, res) => {
//     res.json(communitys.find((ele)=>ele.id == req.params.id));
// });

XueLi.get('/api/conversation',(req,res)=>{
	res.json(conversations);
})

// XueLi.post('/api/lesson',(req,res)=>{
//     res.json(lessons);
// })
// XueLi.post('/api/community',(req,res)=>{
//     res.json(communitys);
// })
